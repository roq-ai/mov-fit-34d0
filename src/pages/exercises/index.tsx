            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  <Th>rest_time</Th>
                  <Th>timestamp</Th>
                  {hasAccess('workout', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>workout</Th>}
                ...
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('workout', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/workouts/view/${record.workout?.id}`}>
                          {record.workout?.intensity_level}
                        </Link>
                      </Td>
                    )}
